package com.ping.test.designpattern.singleton.maintest;
...
public class SingletonTestMain {
	...
	private SingletonTestMain() {
	}

	public static class Holder {
		// 这里的私有没有什么意义
		/* private */static SingletonTestMain instance = new SingletonTestMain();
	}

	public static SingletonTestMain getInstance() {
...
//		while (true) {
			...
			loader.setPath("E:\\eclipseworks\\test\\mytest\\samplepro\\mixdemo\\target\\classes\\com\\ping\\test\\designpattern\\singleton\\maintest\\");
...
class CreateThread extends Thread {
	...
	public void run() {
		Class c;
		try {
			c = cl.loadClass("SingletonTestMain");
