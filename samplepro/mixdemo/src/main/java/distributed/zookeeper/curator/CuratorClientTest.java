...
/**
 * 来源：http://blog.csdn.net/dc_726/article/details/46475633
 * Curator framework's client test. Output: $ create /zktest hello $ ls /
 * [zktest, zookeeper] $ get /zktest hello $ set /zktest world $ get /zktest
 * world $ delete /zktest $ ls / [zookeeper]
 */
public class CuratorClientTest {

	/** Zookeeper info */
	private static final String ZK_ADDRESS = "192.168.38.129:2181";
