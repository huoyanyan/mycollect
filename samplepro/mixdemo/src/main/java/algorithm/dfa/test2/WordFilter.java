 ...
 * http://m.blog.csdn.net/fengshizty/article/details/52373005
 * 
...
public class WordFilter {
	...
	private static final Set set = new HashSet(); // 存储首字
	...
	private static int charConvert(char src) {
		char r = BCConvert.qj2bj(src + "").charAt(0);
